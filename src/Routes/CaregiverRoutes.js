...
import { fetchJobs, getJobById, applyForJob, toggleJobAsFavorite, updateNotificationStatus, getUserNotifications, getFavoriteJobs, getAppliedJobs, filterJobs} from "../Caregiver/JobFunctions.js";
import { createOrUpdateResume, saveCareerRecommendation } from "../Caregiver/UserFunction.js";
const router = Router();
